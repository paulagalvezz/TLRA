...
from .llm import LLM_BASE_URL, LLM_MODEL, client, sse_response, stream_chat
...
app = FastAPI(title="EASY-CHATGPT", version="4")
...
async def chat_stream(request: ChatRequest):
    ...
    return sse_response(stream_chat(payload, _redact_payload(payload)))
